<template>
    ...
    <el-dialog v-model="showLogin"  width="800px" append-to-body>
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				...
				<button class="ghost" @click="goSignIn" id="signIn" >登录</button>
			</div>
			<div class="overlay-panel overlay-right">
				<h1>Hello, Friend!</h1>
				<p>Enter your personal details and start journey with us</p>
				<button class="ghost" @click="goSignUp" id="signUp">注册</button>
			</div>
		</div>
	</div>
</div>
